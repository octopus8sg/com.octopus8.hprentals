 ...
 * (GenCodeChecksum:d2927a7e0e49ccbad509a54fe0bfffc9)
 */
...
class CRM_Hprentals_DAO_RentalsExpense extends CRM_Core_DAO {
  ...
  protected static $_paths = [
    'add' => 'civicrm/rentals/affexpense',
    'view' => 'civicrm/rentals/affexpense?#?RentalsExpense=[id]',
    'update' => 'civicrm/rentals/affexpense?#?RentalsExpense=[id]',
    'comment' => '',
  ];
