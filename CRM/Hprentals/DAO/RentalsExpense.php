 ...
 * (GenCodeChecksum:477248b447a4a15da7f3b8a4ec540469)
 */
...
class CRM_Hprentals_DAO_RentalsExpense extends CRM_Core_DAO {
  ...
  protected static $_paths = [
    'add' => 'civicrm/rentals/angexpense',
    'update' => 'civicrm/rentals/expense?action=update&id=[id]',
    'delete' => 'civicrm/rentals/expense?action=delete&id=[id]',
    'view' => 'civicrm/rentals/expense?action=view&id=[id]',
    'tadd' => 'civicrm/rentals/angexpense#?cid=[id]',
    'tupdate' => 'civicrm/rentals/expense?action=update&id=[id]&cid=[cid]',
    'tdelete' => 'civicrm/rentals/expense?action=delete&id=[id]&cid=[cid]',
    'tview' => 'civicrm/rentals/expense?action=view&id=[id]&cid=[cid]',
  ];
