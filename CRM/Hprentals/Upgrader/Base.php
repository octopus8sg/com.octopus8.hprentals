 ...
 */
class CRM_Hprentals_Upgrader_Base {

  /**
   * @var CRM_Hprentals_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Hprentals_Upgrader(
        'com.octopus8.hprentals',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Hprentals_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Hprentals_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
