 ...
 * (GenCodeChecksum:c40225b7e64bd998545cb5a37a89741e)
 */
...
class CRM_Hprentals_DAO_RentalsMethod extends CRM_Core_DAO {
  ...
  protected static $_paths = [
    'add' => 'civicrm/rentals/angmethod',
    'update' => 'civicrm/rentals/method?action=update&id=[id]',
    'delete' => 'civicrm/rentals/method?action=delete&id=[id]',
    'view' => 'civicrm/rentals/method?action=view&id=[id]',
    'tadd' => 'civicrm/rentals/angmethod#?cid=[id]',
    'tupdate' => 'civicrm/rentals/method?action=update&id=[id]&cid=[cid]',
    'tdelete' => 'civicrm/rentals/method?action=delete&id=[id]&cid=[cid]',
    'tview' => 'civicrm/rentals/method?action=view&id=[id]&cid=[cid]',
  ];
