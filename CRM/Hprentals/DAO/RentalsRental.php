 ...
 * (GenCodeChecksum:8e78d6fdef7f02552414fd7cd9f6ec51)
 */
...
class CRM_Hprentals_DAO_RentalsRental extends CRM_Core_DAO {
  ...
  protected static $_paths = [
    'add' => 'civicrm/rentals/rental?reset=1&action=add',
    'update' => 'civicrm/rentals/rental?reset=1&action=update&id=[id]',
    'delete' => 'civicrm/rentals/rental?reset=1&action=delete&id=[id]',
  ];
  ...
  /**
   * FK to RentalsInvoice
   *
   * @var int|string|null
   *   (SQL type: int unsigned)
   *   Note that values will be retrieved from the database as a string.
   */
  public $first_invoice_id;
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'first_invoice_id' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'description' => E::ts('FK to RentalsInvoice'),
          'where' => 'civicrm_o8_rental_rental.first_invoice_id',
          'table_name' => 'civicrm_o8_rental_rental',
          'entity' => 'RentalsRental',
          'bao' => 'CRM_Hprentals_DAO_RentalsRental',
          'localizable' => 0,
