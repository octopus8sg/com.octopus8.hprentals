 ...
 * (GenCodeChecksum:cb29fa8ac113febb3bcc16ba3cf4a7dd)
 */
...
class CRM_Hprentals_DAO_RentalsPayment extends CRM_Core_DAO {
  ...
  protected static $_paths = [
    'add' => 'civicrm/rentals/angpayment',
    'update' => 'civicrm/rentals/payment?action=update&id=[id]',
    'delete' => 'civicrm/rentals/payment?action=delete&id=[id]',
    'view' => 'civicrm/rentals/payment?action=view&id=[id]',
    'tadd' => 'civicrm/rentals/angpayment#?cid=[id]',
    'tupdate' => 'civicrm/rentals/payment?action=update&id=[id]&cid=[cid]',
    'tdelete' => 'civicrm/rentals/payment?action=delete&id=[id]&cid=[cid]',
    'tview' => 'civicrm/rentals/payment?action=view&id=[id]&cid=[cid]',
  ];
