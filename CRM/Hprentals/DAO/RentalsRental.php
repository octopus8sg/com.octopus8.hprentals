 ...
 * (GenCodeChecksum:519a409748eb9d25aa9ea2fa64470437)
 */
...
class CRM_Hprentals_DAO_RentalsRental extends CRM_Core_DAO {
  ...
  protected static $_paths = [
    'add' => 'civicrm/rentals/angrental',
    'update' => 'civicrm/rentals/rental?action=update&id=[id]',
    'delete' => 'civicrm/rentals/rental?action=delete&id=[id]',
    'view' => 'civicrm/rentals/rental?action=view&id=[id]',
    'tadd' => 'civicrm/rentals/angrental#?cid=[id]',
    'tupdate' => 'civicrm/rentals/rental?action=update&id=[id]&cid=[cid]',
    'tdelete' => 'civicrm/rentals/rental?action=delete&id=[id]&cid=[cid]',
    'tview' => 'civicrm/rentals/rental?action=view&id=[id]&cid=[cid]',
  ];
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'code' => [
          ...
          'title' => E::ts('Code'),
          'description' => E::ts('Rental Code'),
          'required' => FALSE,
          'maxlength' => 21,
          'size' => CRM_Utils_Type::MEDIUM,
          'import' => TRUE,
          'where' => 'civicrm_o8_rental_rental.code',
          'export' => TRUE,
          'default' => NULL,
          'table_name' => 'civicrm_o8_rental_rental',
          'entity' => 'RentalsRental',
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      'index_code' => [
        ...
        'localizable' => FALSE,
        'unique' => TRUE,
        'sig' => 'civicrm_o8_rental_rental::1::code',
      ],
