 ...
 * (GenCodeChecksum:f44d2550b06191f968a422e1ba982a0b)
 */
...
class CRM_Hprentals_DAO_RentalsExpense extends CRM_Core_DAO {
  ...
  protected static $_paths = [
    'add' => 'civicrm/rentals/expense',
    'view' => 'civicrm/rentals/expense?#?RentalsExpense=[id]',
    'update' => 'civicrm/rentals/expense?#?RentalsExpense=[id]',
    'comment' => '',
  ];
