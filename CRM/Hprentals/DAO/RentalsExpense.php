 ...
 * (GenCodeChecksum:5da57b930ba9a06ce478c390dfa19833)
 */
...
class CRM_Hprentals_DAO_RentalsExpense extends CRM_Core_DAO
{
    ...
    protected static $_paths = [
        'add' => 'civicrm/hprentals/expense?reset=1&action=add',
        'view' => 'civicrm/hprentals/expense?reset=1&action=view&id=[id]',
        'update' => 'civicrm/hprentals/expense?reset=1&action=update&id=[id]',
        'delete' => 'civicrm/hprentals/expense?reset=1&action=delete&id=[id]',
    ];
